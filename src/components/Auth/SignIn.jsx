                  ...
                  <form className="flex flex-col gap-2">
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:border-RedShade-400"
                      />
                    </div>
                    ...
                    <div
                      className="w-full text-center bg-RedShade-400 text-white py-2 rounded-lg"
                      onClick={submit}
                    >
                      Sign In
                    </div>
